const Logo = () => {
  return (
    <div className="flex items-center justify-center opacity-50">
      <svg
        className="h-16 w-16 text-gray-900 stroke-current stroke-2 dark:invert"
        viewBox="0 0 24 24"
      >
        <path
          className="fill-none dark:invert"
          d="M12 2c5.522 0 10 4.478 10 10s-4.478 10-10 10S2 17.522 2 12 6.478 2 12 2z"
        ></path>
        <path
          className="fill-gray-900 dark:invert"
      ...
      <div className="font-extrabold text-lg text-gray-900 py-2">MyLysts</div>
    </div>
  );
};
